...
img: /images/blog/svelte_dissapear.jpg
date: "2021-06-15"
video: 5W5i5KhIeaQ
---

import YouTubeEmbed from '~/components/astro/blog/YouTubeEmbed.astro';

Je me suis [lancé le défi](https://dev.to/gosev/defi-framework-ssr-next-vs-vs-nuxt-vs-sveltekit-454d) de créer un blog avec trois frameworks : Svelte/Sveltekit, Vue/Nuxt et React/Next, pour me donner un cas pratique et donc un angle d'attaque pour apprendre les frameworks. 
...
<YouTubeEmbed embedId="5W5i5KhIeaQ" />
...
<YouTubeEmbed embedId="AdNJ3fydeao" />
